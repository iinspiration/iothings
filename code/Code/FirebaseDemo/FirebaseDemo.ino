...
#define _SSID "photocanvas.in.th_2G"        // Your WiFi SSID
#define _PASSWORD "pichaya7831"    // Your WiFi Password
#define PROJECT_ID "iotthings"   // Your Firebase Project ID. Can be found in project settings.
